...
import { Foot, ImgWrap, Img1, Img2, ListWrapp, Aviso, ListItem, FootContainer } from "./FooterElements";
...
<br/>
¿Vende Lenovo mi información personal?<br/>
...
Puede encontrar información adicional sobre el servicio de atención al cliente de Lenovo, incluidos datos de contacto telefónicos y de chat, en la página de contacto.<br/>
      ...
      <Foot>
        <FootContainer>
          <ImgWrap>
            <Img1 src="/images/lenazul.png"></Img1>
            <Img2 src="/images/motoh.png"></Img2>
          </ImgWrap>
          <ListWrapp className="footer">
              <ListItem className="bold-footer"><strong>Links Recomendados</strong></ListItem>
              <ListItem>Motorola-Ready for</ListItem>
              <ListItem>ThinkSystem SE350</ListItem>
              <ListItem>Servicios y soluciones Lenovo</ListItem>
              <ListItem>Data Center</ListItem>
          </ListWrapp>
          <Aviso className="aviso"><p onClick={openModal} style={{cursor:"pointer"}}>Aviso de privacidad </p><br/>©Copyright</Aviso>
        </FootContainer>
      </Foot>
    </>
  );
